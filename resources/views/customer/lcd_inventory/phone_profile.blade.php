    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Phone History</h3>
                </div>
                <div>
                ...
                <div class="m-portlet__body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    @if (auth()->user()->account_type != 'admin') <h5>Phone History of (<b> {{auth()->user()->name}} </b>)</h5>@endif
                                    <br>
                                    <table class="table table-sm table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                @if($product->Account == auth()->user()->name && $product->acc_status != '1' && $product->issued_to == 'Refurbisher')
