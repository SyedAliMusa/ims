                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{route('inventory.create')}}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
												<span>
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="{{route('inventory.quick_create')}}" class="btn btn-brand m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
												<span>
													<i class="la la-plus"></i>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>
                                    <a class="m-btn btn btn-outline-success btn-sm" href="{{route('inventory.show',$product->id)}}">View inventory</a>
                                </td>
