    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Inventory</h3>
                </div>
                <div>
                        ...
                        @foreach($products as $product)
                            @if (count($product['variants']) > 1)
                                @foreach($product['variants'] as $variant)
                                    <tr>
                                        <td id="onChecked">{{$product['id']}}</td>
                                        <td><div style="width: 6%; float: left;">
                                                <img src="{{$product['image']['src']}}" class="img-style zoom" style="background-color: rgb(255, 255, 255); border-radius: 0.25rem; max-width: 100%;"></div> <div style="width: 80%; float: left; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; color: royalblue !important; padding-top: 1%; padding-left: 5px;"><a href="">{{$product['title']}}</a><div>{{$variant['option1']}}</div></div></td>

                                        <td>{{$variant['sku']}}</td>
                                        <td>{{$variant['barcode']}}</td>
                                        <td>{{$variant['inventory_quantity']}}</td>
                                        @if ($product['variants'][0]['inventory_policy']== 'continue')
                                            <td>Continue selling</td>
                                        @else
                                            <td>Stop selling</td>
                                        @endif
                            ...
                            @else
                                <tr>
                                    <td id="onChecked">{{$product['id']}}</td>
                                    <td><div style="width: 6%; float: left;">
                                            <img src="{{$product['image']['src']}}" class="img-style zoom" style="background-color: rgb(255, 255, 255); border-radius: 0.25rem; max-width: 100%;"></div> <div style="width: 80%; float: left; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; color: royalblue !important; padding-top: 1%; padding-left: 5px;"><a href="">{{$product['title']}}</a></div></td>
