        ...
        <div class="m-content">
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__body">
                    <div class="row">
                        <div class="col-md-10">
                            <form action="{{route('single_color')}}" method="get" class="form-inline" role="form">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" required name="colors" id="colors" >
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-4"><p class="text-info">Total (<b class="text-danger">{{count($results)}}</b>) item(s)</p></div>
                        <div class="col-md-4"><p class="text-info">In progress (<b class="text-danger">{{count($inprogress)}}</b>) item(s)</p></div>
                        <div class="col-md-4"><p class="text-info">Dispatched (<b class="text-danger">{{count($dispatched)}}</b>) item(s)</p></div>
