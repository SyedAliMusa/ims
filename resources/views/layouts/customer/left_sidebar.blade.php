                            ...
                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right"><span class="m-menu__arrow "></span>
                                <ul class="m-menu__subnav">
                                    ...
                                    @if(\App\UserPermissions::where('u_id','=', Auth::user()->id)->where('p_id','=', 18)->first())
                                        ...
                                        <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="{{route('color')}}" class="m-menu__link "><span class="m-menu__link-text">Folder Report</span></a></li>
                                        <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="{{route('single_color')}}" class="m-menu__link "><span class="m-menu__link-text">Single Color Folder Report</span></a></li>
